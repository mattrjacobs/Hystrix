...
public class HystrixAtomicLongArrayNoHotReadsRollingNumber extends HystrixRollingNumber<HystrixAtomicLongBucket> {
     ...
     */
    @Deprecated
    public HystrixAtomicLongArrayNoHotReadsRollingNumber(HystrixProperty<Integer> timeInMilliseconds, HystrixProperty<Integer> numberOfBuckets) {
        this(timeInMilliseconds.get(), numberOfBuckets.get());
    }

    public HystrixAtomicLongArrayNoHotReadsRollingNumber(int timeInMilliseconds, int numberOfBuckets) {
    ...
    public HystrixAtomicLongArrayNoHotReadsRollingNumber(HystrixTime time, int timeInMilliseconds, int numberOfBuckets) {
