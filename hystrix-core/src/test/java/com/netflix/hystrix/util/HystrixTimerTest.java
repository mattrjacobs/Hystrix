...
public class HystrixTimerTest {
    ...
    public void testReset() {
        ...
        HystrixTimer.ScheduledExecutor ex = timer.executor.get();
        ...
        HystrixTimer.ScheduledExecutor ex2 = timer.executor.get();
    ...
    public void testThreadPoolSizeDefault() {
        HystrixTimer.getInstance().startThreadIfNeeded();

        HystrixTimer hystrixTimer = HystrixTimer.getInstance();
        assertEquals(Runtime.getRuntime().availableProcessors(), hystrixTimer.executor.get().executor.getCorePoolSize());
    }
    ...
    public void testThreadPoolSizeConfiguredWithBuilder() {
        ...
        assertEquals(1, hystrixTimer.executor.get().executor.getCorePoolSize());
    }
